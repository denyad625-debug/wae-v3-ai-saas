          ...
          <p className="text-sm text-text-secondary">
            ...
            <form className="flex gap-2">
              <input
                ...
                className="px-3 py-2 text-sm border border-text-secondary/20 rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button type="submit" className="px-4 py-2 text-sm font-medium text-background bg-primary rounded-md hover:opacity-90">
                Subscribe
              </button>
            </form>
        </div>
